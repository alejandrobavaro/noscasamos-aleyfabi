  ...
  const timelineItems = [
    {
      ...
      description: "Los novios y el equipo de bridal party se preparan en suites exclusivas. Maquillaje, peinado y los últimos detalles para el gran momento.",
      icon: "💅",
      images: [
    ...
    },
    {
      time: "17:30 hs",
      title: "Primer Look",
      description: "Revelación del look completo de los novios ante sus padres y padrinos. Momento emotivo con lágrimas de felicidad.",
      icon: "👰",
      images: [
    ...
    },
    {
      ...
      description: "Recepcionaremos a nuestros invitados con un cóctel de bienvenida de 5 estaciones y música en vivo.",
      icon: "🍸",
      images: [
    ...
    },
    {
      ...
      description: "Celebración del matrimonio en el jardín principal con arreglos florales espectaculares y música de cuerdas en vivo.",
      icon: "💒",
      images: [
    ...
    },
    {
      time: "21:00 hs",
      title: "Cena Épica",
      description: "Banquete con menú degustación de 7 pasos diseñado por chef estrella Michelin, con pairing de vinos exclusivos.",
      icon: "🍽️",
      images: [
    ...
    },
    {
      ...
      description: "Brindis por los novios con champagne vintage y apertura de pista con coreografía sorpresa.",
      icon: "💃",
      images: [
    ...
    },
    {
      ...
      description: "Corte de torta de 5 pisos con show de luces y continuación de la celebración con DJ internacional.",
      icon: "🎂",
      images: [
        "/img/itinerario/torta-1.jpg",
        "/img/itinerario/torta-2.jpg"
      ],
      details: [
    ...
    },
    {
      time: "02:00 hs",
      title: "Hora Loca",
      description: "Sorpresas, accesorios brillantes y energía al máximo con animadores profesionales.",
      icon: "🎉",
      images: [
    ...
    },
    {
      ...
      description: "Gran final con show de luces, fuegos artificiales y despedida con estilo.",
      icon: "✨",
      images: [
    ...
    },
    {
      ...
      description: "Continuación de la fiesta en ubicación secreta para los más resistentes.",
      icon: "🥂",
      images: [
        "/img/itinerario/after-1.jpg",
        "/img/itinerario/after-2.jpg"
      ],
      details: [
  ...
  return (
    <div className="itinerario-container">
      <div className="itinerario-header">
        <h1>Itinerario</h1>
        <p>23 de Noviembre 2025 - Un día que marcará el tiempo</p>
        <div className="floral-divider"></div>
      </div>

      <div className="timeline-controls">
        <button onClick={() => setAutoPlay(!autoPlay)}>
          {autoPlay ? '⏸ Pausar' : '▶️ Reanudar'} Autoplay
        </button>
      </div>
      ...
      <div className="timeline-content-container">
        <div className="timeline-details">
          <div className="timeline-item">
            <div className="timeline-time">{timelineItems[activeItem].time}</div>
            <div className="timeline-content">
              <h3>{timelineItems[activeItem].title}</h3>
              <p>{timelineItems[activeItem].description}</p>
              <div className="timeline-icon">{timelineItems[activeItem].icon}</div>
      ...
      <div className="additional-info">
        ...
        <p>Contaremos con servicio de fotografía 360°, realidad virtual para familiares a distancia, y un equipo de coordinación disponible las 24 horas.</p>
      </div>
