...
import "../assets/scss/_03-Componentes/_Mesas.scss";
...
function Mesas() {
  ...
  const handleDragEnd = (result) => {
    ...
    // Mover de lista a mesa
      ...
      // Verificar si ya está asignado a otra mesa
  ...
  const assignGroupToTable = (groupName, tableId) => {
    ...
    setTables(prevTables => 
      prevTables.map(t => {
        if (t.id === tableId) {
          // Filtrar invitados que no estén ya asignados a otras mesas
  ...
  return (
    <DragDropContext onDragEnd={handleDragEnd}>
      <div className="mesas-compact-container">
