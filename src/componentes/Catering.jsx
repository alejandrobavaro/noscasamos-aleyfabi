...
import cateringData from '/src/json/catering.json';
import "../assets/scss/_03-Componentes/_Catering.scss";

function Catering() {
  const [menu, setMenu] = useState(cateringData.menuOptions);
  const [restrictions] = useState(cateringData.dietaryRestrictions);
  ...
  const saveNotes = () => {
    console.log('Notas de catering guardadas:', notes.catering);
  };
